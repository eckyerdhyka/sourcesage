...
# "This class defines the input schema for the CreateSignup mutation. It requires a name, email,
# and password.the password must be at least 6
# characters long."
#
...
class CreateSignupInputSchema(Schema):
    ...
    gender = fields.Bool(required=False)
